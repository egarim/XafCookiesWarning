...
namespace XafCookiesWarning.Module.BusinessObjects
{
 
    public class CookiesMessage : IXafEntityObject/*, IObjectSpaceLink*/, INotifyPropertyChanged
    {
